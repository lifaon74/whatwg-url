(function (global, factory) {
	...
	(factory((global.bundle = {}),global.http));
...
class URLSearchParams extends MapLike {
    constructor(init) {
        super();
